 ...
 * fila de amostras positivas deve conter as amostras que testaram positivo (idosos na frente); 
 * fila de amostras negativas deve conter as amostras que testaram negativo (idosos na frente).
 */
